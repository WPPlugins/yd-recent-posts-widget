...
/**
 *	TODO:
 *	Bugfix: multiple widget instance (3.0.2)
 *	Bugfix: parameter overriding in template function (3.0.2)
 *	Warning when nothing selected for display (3.0.2)
 *
 *	Features: ?
